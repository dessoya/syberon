...
function MainMenuWindow:initialize(renderer, video_cb, interface_cb, play_cb, quit_cb)

	self.renderer = renderer

	self.window = GUI.Window:new(10, 10, 350, 600)	
	self.window:addChild(GUI.Button:new(10, 10, 330, 25, "Video", video_cb))
	self.window:addChild(GUI.Button:new(10, 45, 330, 25, "Keys"))
	self.window:addChild(GUI.Button:new(10, 80, 330, 25, "Interface", interface_cb))
	self.window:addChild(GUI.Button:new(10, 115, 330, 25, "Play", play_cb))
